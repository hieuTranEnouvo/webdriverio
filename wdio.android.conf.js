...
exports.config = {
    ...
    services: ['chromedriver', 'appium', 'docker'],
    ...
    // reporters: ['spec', ['allure', allure_config], 'cucumberjs-json', {
    ...
    cucumberOpts: {
        ...
        // tagExpression: "@sanity or @regression",
        tagExpression: "",
   ...
   */
    beforeScenario: async function (world) {
        ...
        await allureReporter.addSeverity(world.name)
    },
    /**
     *
     * Runs before a Cucumber Scenario.
